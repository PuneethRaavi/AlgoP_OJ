        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "questionkey",
                    models.CharField(
                        blank=True, help_text="The UUID key ", max_length=100
                    ),
                ),
                (
                    "title",
                    models.CharField(
                        help_text="The title of the problem.", max_length=255
                    ),
                ),
                (
                    "description",
                    models.TextField(
                        help_text="A detailed description of the problem, including input/output format."
                    ),
                ),
                (
                    "difficulty",
                ...
                (
                    ...
                    models.FloatField(
                        default=1.0,
                        help_text="Time limit in seconds for a solution to run.",
                    ),
                ),
                (
                    "memory_limit",
                    models.IntegerField(
                        default=256, help_text="Memory limit in megabytes (MB)."
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "expected_output",
                    models.TextField(
                        help_text="The expected output for this test case."
                    ),
                ),
